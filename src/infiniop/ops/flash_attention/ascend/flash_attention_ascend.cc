...
infiniStatus_t Descriptor::create(
    ...
    auto result = FlashAttentionInfo::create(out_desc, l_desc, q_desc, k_desc, v_desc, mask_desc, mask_type);
    CHECK_RESULT(result);
    ...
    aclnnTensorDescriptor_t mask = info.is_masked == true ? new aclnnTensorDescriptor(mask_desc) : nullptr;
    ...
    int64_t sparse_mode = info.is_masked == true ? 1 : 0;
    ...
    CHECK_ACL(aclnnPromptFlashAttentionV3GetWorkspaceSize(
        ...
        info.is_masked ? mask->tensor : nullptr,
