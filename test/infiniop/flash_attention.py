...
_TEST_CASES = [
    # (
    #     (1, 256, 32, 64), # Output shape
    #     (1, 256, 32, 64), # Query shape
    #     (1, 500, 4, 64),  # Key shape
    #     (1, 500, 4, 64),  # Value shape
    #     0,                # Mask type
    # ),
    (
        (1, 2, 2, 10),  # Output shape
        (1, 2, 2, 10),  # Query shape
        (1, 2, 2, 10),  # Key shape
        (1, 2, 2, 10),  # Value shape
        0,                # Mask type
    ),
]
